...
- shared configuration sync is limited to non-secret settings such as selected calendars, Google account descriptors, advanced preferences, and native Booking setup; Google account tokens, Apple permission state, booking private keys, inbox admin tokens, deploy-key private keys, local generated-page paths, and editable template files stay local to each device, and each device can opt out from Advanced without affecting the others
