...
- shared configuration sync is limited to non-secret settings such as selected calendars, Google account descriptors, and advanced preferences; Google account tokens and Apple permission state stay local to each device, and each device can opt out from Advanced without affecting the others
