...
- `settings.booking.subtitle`
- `settings.booking.setup`
- `settings.booking.page.status`
- `settings.booking.inbox.status`
- `settings.booking.requests.status`
- `settings.booking.message`
- `settings.booking.page-url`
- `settings.booking.inbox-url`
- `settings.booking.publish`
- `settings.booking.check-inbox`
- `settings.booking.send-test-request`
