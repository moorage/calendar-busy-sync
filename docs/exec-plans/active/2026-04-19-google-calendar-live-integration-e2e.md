...
- 2026-04-19: the roster UI became much clearer once it exposed per-account cards with one destination-calendar picker and compact overview counts instead of treating Google as one shared reconnect flow.
